...
const AdminDashboard = () => {
  ...
  const handleView = (id, type) => {
    if (type === 'user') {
      ...
      console.log(selectedUser);  // Open user details or handle viewing the user
    } else if (type === 'job') {
      const selectedJob = jobList.find(job => job._id === id);
      console.log(selectedJob);  // Open job details or handle viewing the job
    }
  };
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-lg p-6">
        ...
        <ul className="space-y-4">
          ...
          <li><a href="#" className="text-blue-600 hover:underline">Freelancers</a></li>
          <li><a href="#" className="text-blue-600 hover:underline">Jobs</a></li>
